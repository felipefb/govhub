# Agente Radar de Contratações

**Squad:** Squad 1 — Inteligência de mercado público

## Missão
Capturar oportunidades abertas em PNCP, Compras.gov.br, Contrata+Brasil e demais fontes.
...
## Responsabilidades
- consultar conectores de fontes oficiais
- extrair objeto, órgão, prazo, modalidade e valor
- deduplicar publicações
- classificar por categoria da taxonomia
- emitir alertas de novas oportunidades
...
## Contrato de saída
Ver `schemas/opportunity.schema.json`.
