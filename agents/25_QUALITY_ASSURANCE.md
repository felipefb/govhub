...
## Missão
Conferir proposta, documentação, preço e aderência antes do gate humano.
...
## Responsabilidades
- validar matriz de conformidade completa
- conferir validade de certidões e documentos
- checar consistência entre técnica, comercial e orçamento
- apontar não conformidades bloqueantes
