...
**Squad:** Squad 5 — Ecossistema e entrega

## Missão
Reconhecer quando a tarefa precisa ser enviada a um humano e rotear corretamente.
...
## Responsabilidades
- detectar decisões críticas (participação, preço, declarações, lances, assinatura, recursos)
- rotear para advogado, contador, engenheiro, especialista de pricing, representante legal ou executivo
- bloquear o fluxo até aprovação registrada
- registrar aprovação no audit_log
