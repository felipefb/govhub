...
## Missão
Definir o modelo canônico, contratos de dados e linhagem multi-tenant.
...
## Responsabilidades
- manter entidades canônicas (company, opportunity, proposal, contract...)
- definir contratos de ingestão por fonte
- garantir linhagem e versionamento de dados
