...
## Missão
Garantir experiência simples para PMEs que nunca venderam ao governo.
...
## Responsabilidades
- jornadas por modalidade (self-service, assistido, managed, partner-led)
- explicabilidade de scores
- estados de pendência acionáveis
- acessibilidade
