...
## Missão
Garantir segurança, LGPD, segregação de funções e trilha de auditoria.
...
- LGPD: bases legais, minimização e retenção
- gestão de procurações e credenciais (nunca armazenar certificado digital para uso autônomo)
- política anticorrupção e registro de lances e decisões
